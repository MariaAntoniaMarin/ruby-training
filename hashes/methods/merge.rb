...
p kitchen.merge(market) #=> {:bread=>"2 loaves", :yogurt=>"20 cans", :milk=>"10 gallons", :garlic=>"3 cloves", :tomatoes=>"5 batches"}
...
p custom_merge(market, kitchen) #=> {:garlic=>"3 cloves", :tomatoes=>"5 batches", :milk=>"100 gallons", :bread=>"2 loaves", :yogurt=>"20 cans"}
